...
from prometheus_ultra.learning.scanner import KnowledgeScanner, ScanSource
from prometheus_ultra.learning.learn_feedback import LearnFeedbackTracker
from prometheus_ultra.learning.knowledge_rumination import KnowledgeRuminationEngine
from prometheus_ultra.learning.semantic_learner import SemanticLearner
from prometheus_ultra.evolution.attribution_scoring import AttributionEvolutionScoring
from prometheus_ultra.evolution.playbook_inheritance import PlaybookInheritance
from prometheus_ultra.safety.two_level_blocker import TwoLevelBlockerEscalation
...
class Omega:
    ...
    def __init__(self, config: ZConfig | None = None, db_path: str | None = None,
        ...
        # T3: GitHub 机制提取轨道
        from prometheus_ultra.mechanisms.mechanism_extractor import MechanismExtractor
