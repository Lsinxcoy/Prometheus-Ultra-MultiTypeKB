...
Run: `python -c "import ast; ast.parse(open('E:/Prometheus-Ultra/src/prometheus_ultra/life.py').read()); print('OK')"`
Expected: OK
...
Run: `python -c "import ast; ast.parse(open('E:/Prometheus-Ultra/src/prometheus_ultra/lifecycle/cns_orchestrator.py').read()); print('OK')"
Expected: OK
...
cd /e/Prometheus-Ultra && PYTHONPATH=E:/Prometheus-Ultra/src python -m prometheus_ultra.services.api_server --port 9200 &
sleep 3
```
