...
```python
# life.py __init__ 添加
from prometheus_ultra.learning.paper_fetch_mcp import PaperFetchMCP
...
```python
# life.py __init__ 添加
from prometheus_ultra.memory.multi_hop import MultiHopReasoner
...
```python
# life.py __init__ 添加
from prometheus_ultra.memory.topological_retrieval import TopologicalRetriever
...
```python
# life.py __init__ 添加
from prometheus_ultra.prompt.brainstorming import BrainstormingEngine
