...
class TestHandbookBuild:
    def test_build_from_src_tree(self):
        ...
        from prometheus_ultra.mechanisms.handbook import HarnessHandbook
...
class TestT4Integration:
    def test_compile_attaches_target_location(self, tmp_path, monkeypatch):
        ...
        from prometheus_ultra.mechanisms import handbook as hb_mod
        class FakeCand:
            module = "prometheus_ultra.evolution.evolution_engine"
        ...
        assert mech.target_location["module"] == "prometheus_ultra.evolution.evolution_engine"
