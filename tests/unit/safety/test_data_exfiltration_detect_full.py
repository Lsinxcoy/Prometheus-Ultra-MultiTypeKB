...
class TestPatternConstants:
    ...
    def test_credit_card_pattern(self):
        from prometheus_ultra.safety.data_exfiltration_detect import _CREDIT_CARD_RE
        assert _CREDIT_CARD_RE.match("1234-5678-9012-3456") is not None
        assert _CREDIT_CARD_RE.match("1234 5678 9012 3456") is not None

    def test_ssn_pattern(self):
        from prometheus_ultra.safety.data_exfiltration_detect import _SSN_RE
        assert _SSN_RE.match("123-45-6789") is not None

    def test_api_key_pattern(self):
        from prometheus_ultra.safety.data_exfiltration_detect import _API_KEY_RE
    ...
    def test_api_key_param_pattern(self):
        from prometheus_ultra.safety.data_exfiltration_detect import _API_KEY_PARAM_RE
    ...
    def test_password_pattern(self):
        from prometheus_ultra.safety.data_exfiltration_detect import _PASSWORD_RE
    ...
    def test_bank_account_pattern(self):
        from prometheus_ultra.safety.data_exfiltration_detect import _BANK_ACCOUNT_RE
        assert _BANK_ACCOUNT_RE.search("account-number=12345678") is not None
        assert _BANK_ACCOUNT_RE.search("account number: 12345678") is not None

    def test_token_pattern(self):
        from prometheus_ultra.safety.data_exfiltration_detect import _TOKEN_RE
        assert _TOKEN_RE.search("token=abcdefghijklmnopqrstuvwxyz123456") is not None

    def test_sensitive_patterns_not_empty(self):
        from prometheus_ultra.safety.data_exfiltration_detect import _SENSITIVE_PATTERNS
