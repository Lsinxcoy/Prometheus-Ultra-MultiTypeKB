...
薄弱点 (代码级证据):
  src/prometheus_ultra/evolution/evolution_quality_gates.py:293-296
...
生产调用方 (真实门控):
  src/prometheus_ultra/life.py:2315-2319
...
def test_check_step_blocks_emits_warning(caplog):
    ...
    import logging
    g = EvolutionQualityGates()
    with caplog.at_level(logging.WARNING, logger="prometheus_ultra.evolution.evolution_quality_gates"):
