...
class TestC5MultiHost:
    def test_experience_isolated_by_host_id(self, omega, monkeypatch):
        ...
        a_nodes = omega.store.get_nodes_by_type(__import__("prometheus_ultra.foundation.schema", fromlist=["NodeType"]).NodeType.PROCEDURE, branch="agent_a")
        b_nodes = omega.store.get_nodes_by_type(__import__("prometheus_ultra.foundation.schema", fromlist=["NodeType"]).NodeType.PROCEDURE, branch="agent_b")
