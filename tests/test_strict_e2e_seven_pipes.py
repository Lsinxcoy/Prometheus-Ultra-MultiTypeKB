...
from prometheus_ultra.life import Omega  # noqa: E402
...
def test_recall_returns_real_stored_content(omega):
    ...
    from prometheus_ultra.foundation.schema import SearchResults, SearchHit
...
def test_knowledge_accumulation_shared_across_pipes(omega):
    ...
    from prometheus_ultra.foundation.schema import SearchResults
